...
declare module '$env/static/private' {
	...
	export const Simatic_OAM: string;
	export const Simatic_OAM_DATA: string;
	...
	export const YFAS_Shopfloor_PC: string;
